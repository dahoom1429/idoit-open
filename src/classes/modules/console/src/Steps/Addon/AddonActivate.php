...
class AddonActivate implements Step, Undoable
{
    private $done;
    ...
    {
        return 'Activate Addon ' . $this->id . ' for tenant ' . $this->tenantId;
    }
    ...
    public function process(Messages $messages)
    {
        ...
        $result = $this->manager->activateAddOn($this->id);
        $this->done = $result;
        return $result;
    }
    ...
    public function undo(Messages $messages)
    {
        ...
        return $this->manager->deactivateAddOn($this->id);
    }
}
